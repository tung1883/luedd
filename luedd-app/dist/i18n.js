...
(function () {
  const STRINGS = {
    en: {
      ...
      ig_doc_post: "doc_id — post / reel",
      ig_doc_profile: "doc_id — profile grid",
      ig_note: "Optional. Extension-detected Instagram pages use the browser's own cookies and built-in query ids. Fill these in only for hand-pasted URLs, or when the built-in ids stop working (they rot every few weeks — refresh from DevTools → Network). See insta-graphql.md.",
    ...
    de: {
      ...
      ig_doc_post: "doc_id — Beitrag / Reel",
      ig_doc_profile: "doc_id — Profilraster",
      ig_note: "Optional. Vom Add-on erkannte Instagram-Seiten nutzen die Browser-Cookies und eingebaute Query-IDs. Nur für manuell eingefügte URLs ausfüllen, oder wenn die eingebauten IDs nicht mehr funktionieren (sie verfallen alle paar Wochen — im DevTools-Netzwerk-Tab aktualisieren). Siehe insta-graphql.md.",

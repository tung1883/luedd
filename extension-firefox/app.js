...
export default class App {
    ...
    register() {
        ...
        // Firefox's `downloads` API has no `onDeterminingFilename` event (Chrome-only) -
        // without this guard the whole register() call throws on Firefox and none of
        // the listeners below it (webRequest, context menu, tab tracking) ever attach.
